...
import { Avatar, Button, Col, Divider, Flex, Form, Input, List, Row, Typography } from "antd";
...
const CommentItem: React.FC<CommentItemProps> = ({ isClosedStatus }) => {
  ...
  return (
    <>
      ...
      <Divider className="customize-divider"></Divider>
        ...
        {
          !isClosedStatus && (<div className='centered-input' style={{ width: '100%' }}>
